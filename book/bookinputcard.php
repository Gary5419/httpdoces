      ...
      <div id="mainField">
        ...
        <section id="mainField">
			...
			<p class="p14">
				...
				?>
					<p>WEBでの申込はクレジットカード支払のみとさせていただいております。それ以外の支払方法をご希望の方は、ポケカルお客様センターまでお電話ください。</p>
					<p>ポケカルお客様センター(9：00～18：00受付)<font color="blue"><b>03-5652-7072</b></font></p>
				<?php
				}
				?>
			</p>
					...
					<div class="carttable">
						...
						<table>
							<tr>
								...
								<td>
									<strong><?php print(htmlspecialchars($eventname, ENT_QUOTES));?></strong>
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<td>
									...
									<?php print(htmlspecialchars($_SESSION['mannum'], ENT_QUOTES));?>
									人
									...
									?>
										...
										<?php print(htmlspecialchars($_SESSION['boynum'], ENT_QUOTES));?>
										人
										<?php
									}
									?>
							...
							<tr class="last">
								<td class="single" colspan="2">
									...
									?>
										<span class="p14">
											<p><strong>
												※本申込ではクレジットカードによるお支払のみを受け付けています。クレジットカード以外でのお支払をご希望の方は、ポケカルお客様センターまでご連絡ください。
											</strong></p>
											ポケカルお客様センター(9：00～18：00受付)<font color="blue"><b>03-5652-7072</b></font>
										</span>
									<?php
									}
									?>
