      ...
      <div class="main">
        <div class="wrapper">
		  <ul class="breadcrumb">
            ...
            <li>ツアー・イベントのキャンセル</li>
          </ul>

            
            <div class="mb10"></div>
            
            <h1 class="headline01"><p>ツアー・イベントのキャンセル</p></h1>
...
<li class="visited"><span>1</span><br>予約番号・確認キー入力</li>
<li><span>2</span><br>キャンセル内容確認</li>
<li><span>3</span><br>キャンセル完了</li>
</ol>
...
<div class="mlr10">			
                ...
                <div class="panel-body canceltable">
					<table>
                    	<tr>
                            <th>予約番号</th>
                            <td>
                                <input class="form-input" type="text" size="37" name="bookingnumber" onFocus="f_onFocus(this)" onBlur="f_onBlur(this)" style="ime-mode: disabled"
                                                                    <?php
                                                                    ...
                                                                    ?>
                                                                    >
                                　　<span class="p14">6桁の番号を入力ください</span>
                            </td>
                        </tr>
                        <tr>
                            <th>確認キー</th>
                            <td>
                                <input class="form-input" type="text" size="37" name="cancelcheckkey" onFocus="f_onFocus(this)" onBlur="f_onBlur(this)" style="ime-mode: disabled"
                                                                    <?php
                                                                    ...
                                                                    ?>
                                                                    >
                                　　<span class="p14">10桁の番号を入力ください</span>
                            </td>
                        </tr>
					</table>
				</div>
                ...
                <p class="btn-detail"><a href="javascript:void(0);" onclick="document.cancelform.submit();">入力内容の確認</a></p>
