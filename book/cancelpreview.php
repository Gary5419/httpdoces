...
<li class="visited"><span>2</span><br>キャンセル内容確認</li>
...
<div class="mlr10">		
                ...
                <tr>
                <td style="width:49%;">
                <p class="btn-detail"><a href="<?php echo $url_currentdir.FILENAME_CANCEL_ID_KEYINPUT; ?>">前の画面に戻る</a></p>
                </td>
                <td>&nbsp;</td>
                <td style="width:49%;">
                <p class="btn-detail"><a href="#" onclick="document.cancelform.submit();">予約をキャンセルする</a></p>
                </td>
                ...
                <!--
					<table border="0" cellpadding="0" cellpadding="0" width="100%">
						<tr>
							<td><input type="submit" value="予約キャンセル" class="cancelButton" name=""></td>
						</tr>
					</table>
                -->
                                ...
                                <?php
                                    #print("<td><input type=\"submit\" value=\"入力画面に戻る\" class=\"backButton\" onclick=\"location.href='".$url_currentdir.FILENAME_CANCEL_ID_KEYINPUT."'\"></td>");
                                ?>
