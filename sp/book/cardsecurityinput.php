...
<!-- ##### BODY ##### -->
	<section>
		...
		<form name="frm_booking" method="post" action="<?php print($url_currentdir.$filename_current); ?>" id="<?php print($screenid_current); ?>">
			...
			<div class="carttableInfo">
				<input class="textbox cardsec" type="text" id="cardkakuninno" name="cardkakuninno" maxlength="4" onFocus="f_onFocus(this)" onBlur="f_onBlur(this)" onChange="zenhan(this);"
				<?php
				...
				<img src="/images/book/cardsecuritycode_renew.gif" width="100%" style="display:inline;" />
