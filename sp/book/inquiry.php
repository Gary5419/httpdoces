...
*/
	$toiawasename = $_SESSION['toiawasename'];
	$toiawasemail = $_SESSION['toiawasemail'];
	$toiawasetext = $_SESSION['toiawasetext'];
}
...
<tr>
<th>ご質問・ご意見・ご要望</th>
<td><textarea name="toiawasetext" rows="10" style="-webkit-appearance: none !important;border-radius:0;"><?php print($toiawasetext); ?></textarea></td>
</tr>
</table>
</div>
                </div>
				...
				<div class="mlr15">
                <p class="btn-detail"><a href="javascript:void(0);" class="btn-detail" onclick="document.<?php print($screenid_current); ?>.submit();">入力内容確認</a></p>
